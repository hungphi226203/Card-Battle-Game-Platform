...
public interface UserCardRepository extends JpaRepository<Inventory, Long> {
    ...
    // New methods for deck functionality
    List<Inventory> findByUserUserIdAndIsOnDeckTrue(Long userId);
    ...
    List<Inventory> findByInventoryIdInAndUserId(@Param("inventoryIds") List<Long> inventoryIds, @Param("userId") Long userId);
}